...
export default function Home() {
    return (
        <>
            <div className="flex justify-center items-center w-full h-[100vh] overflow-hidden bg-[#1c1f26] flex-col">

                <div className="w-[80%] max-w-[550px] justify-center items-center flex-col flex text-center sm:w-[90%]">
